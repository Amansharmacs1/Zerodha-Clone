...
function Hero() {
    ...
    <div className="container container d-flex flex-column justify-content-center align-items-center text-center mt-5">

    <h3 className="p-3">We pioneered the discount broking model in India.<br/>
       Now, we are breaking ground with our technology. 
        </h3>
    </div>
    <hr/>
    <div className="container p-5 fs-5 text-muted">
        <div className="row ">
